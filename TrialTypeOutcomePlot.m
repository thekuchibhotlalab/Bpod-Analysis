...
switch Action
    case 'init'
        ...
        set(AxesHandle,'TickDir', 'out','YLim', [-5-.5, -.5], 'YTick', -5:1:-1,'YTickLabel', {'Middle', 'Probe-NOGO' 'Probe-GO' 'NoGo' 'Go'}, 'FontSize', 11);
    ...
    case 'update'
        ...
        MaxTrialType = max(TrialTypeList);
        set(AxesHandle,'YLim',[-5-.5, -.5], 'YTick', -5:1:-1,'YTickLabel', {'Middle', 'Probe: NOGO' 'Probe: GO' 'NoGo' 'Go'});
        if CurrentTrial<1
            CurrentTrial = 1;
        end
